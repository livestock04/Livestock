...
$terneras = $consulta -> fetchAll(PDO::FETCH_OBJ);
...
<head>
    ...
    <title>Terneras</title>
</head>
<body>
<div class="topnav" id="myTopnav">
  <a href="../../html/bovinos.php" class="active">Atras</a>
  <a href="select_terneras.php">Inicio</a>
...
<div class="rwd">
    <table class="rwd_auto">
        ...
        if($dato->categoria_id_categoria == 1){                            
