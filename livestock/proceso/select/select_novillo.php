...
$novillo = $consulta -> fetchAll(PDO::FETCH_OBJ);
...
<head>
    ...
    <title>Novillos</title>
</head>
<body>
<div class="topnav" id="myTopnav">
  <a href="../../html/bovinos.php" class="active">Atras</a>
  <a href="select_novillo.php">Inicio</a>
 ...
 <div class="rwd">
  <table class="rwd_auto">
      <thead>
        ...
        if($dato->categoria_id_categoria == 4){                            
