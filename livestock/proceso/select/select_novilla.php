...
$novilla = $consulta -> fetchAll(PDO::FETCH_OBJ);
...
<head>
    ...
    <title>Novillas</title>
</head>
<body>
<div class="topnav" id="myTopnav">
  <a href="../../html/bovinos.php" class="active">Atras</a>
  <a href="select_novilla.php">Inicio</a>
...
<center><h1>Novillas</h1></center>
   ...
   <div class="rwd">
    <table class="rwd_auto">
        ...
        if($dato->categoria_id_categoria == 3){                            
